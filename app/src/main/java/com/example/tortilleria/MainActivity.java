                ...
                if (dataSnapshot.child("Users").child(phone).exists())
                {
                    ...
                    if (usersData.getPhone().equals(phone)){
                        if (usersData.getPassword().equals(password))
                        {
                            ...
                            Toast.makeText(MainActivity.this, "La contrasena es incorrecta", Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
                    ...
                    Toast.makeText(MainActivity.this, "Cuenta de " + phone + "No esta registrada", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
